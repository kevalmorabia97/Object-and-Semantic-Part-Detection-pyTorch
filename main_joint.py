...
parser.add_argument('-tr', '--train_split', type=str, default='person_train')
parser.add_argument('-val', '--val_split', type=str, default='person_val')
parser.add_argument('-ocf', '--obj_class2ind_file', type=str, default='person_object_class2ind')
parser.add_argument('-pcf', '--part_class2ind_file', type=str, default='person_part_mergedclass2ind')
